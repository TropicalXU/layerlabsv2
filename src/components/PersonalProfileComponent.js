                ...
                <div className='container-fluid row-contact'>
                    ...
                    <div className='container pb-5'>
                        ...
                        <div className='row profile-card py-5'>
                            ...
                            <div className='col-12 col-md-6 font-two py-4'>
                                ...
                                <Link to='/contact' className='btn btn-primary my-4'>Get in touch<span className='fa fa-chevron-right ml-2'></span></Link>
