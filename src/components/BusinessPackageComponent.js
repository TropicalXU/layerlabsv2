        ...
        return (
            <>
                <div className='row'>
                    ...
                    <div className='col-12 col-lg-4'>
                        <Card className='p-4 my-3'>
                            <img src='/assets/images/discover.jpg' className='custom-img img-fluid my-4' width='100%' height='340px' alt='Phase 1' />
                            <ul className='list-unstyled text-center font-two grey-text-lite pt-3'>
                ...
                <div className='col-12 col-lg-4'>
                    <Card className='p-4 my-3'>
                        <img src='/assets/images/protection.jpg' className='custom-img img-fluid my-4 py-3' width='100%' height='340px' alt='Phase 1' />
                        <ul className='list-unstyled text-center font-two grey-text-lite pt-3'>
                ...
                <div className='col-12 col-lg-4'>
                    <Card className='p-4 my-3'>
                        <img src='/assets/images/web-launch.jpg' className='custom-img img-fluid my-4 py-3' width='100%' height='340px' alt='Phase 1' />
                    ...
                    <div className='bkg-white py-5'>
                        <div className='row'>
                            <div className='col-12'>
                                <h1 className='font-two grey-text-lite py-4'>Business Package Details</h1>
                            </div>
                        </div>
