        ...
        <>
            ...
            <div className='row'>
                <div className='col-12 col-md-4'>
                    <img src='/assets/images/insta1.png' className='process-img my-4' width='100%' height='470px' alt='instagram' />
                </div>
                <div className='col-12 col-md-4'>
                    <img src='/assets/images/insta2.png' className='process-img my-4' width='100%' height='470px' alt='instagram' />
                </div>
                <div className='col-12 col-md-4'>
                    <img src='/assets/images/business-app.png' className='process-img my-4' width='100%' height='470px' alt='instagram' />
                </div>
            </div>
